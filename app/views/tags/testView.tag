<div class="glow">
	...
	<table>
	    <tfoot>
	    	<tr><td></td><td></td><td></td><td><button data-bind="click: addBhaviour">Add</button></td></tr>
	    </tfoot>
	    <tbody data-bind="foreach: bhaviours">
	        <tr class="bhaviour_row" id="bhaviour_">
	            <td data-bind="foreach: syntax">
	            	<span class="termWrapper">
		            	<span data-bind="attr: {'id': 'term_'+id(), 'class': 'term term_'+type()}, text: name"></span>
	            ...
	            <td>
	            	<input size="80" class="command_input" data-bind="value: command, attr: {id: 'command_input_'+id(), 'data-id': id()}" />
	            </td>
	            <td>
