	...
	<table>
		...
		<tr><td>
			<ul class="definition_term_container" data-bind="attr: {'id': 'definitionTerms_'+id()}">
				<li data-bind="event: {mouseover: function() {definition.terms.makeActive('object')}}">Object</li>
				<li>Article</li>
				<li>Conjunction</li>
				<li data-bind="event: {mouseover: function() {definition.terms.makeActive('synonym')}}">
					Synonym
				</li>
			</ul>
		</td></tr>
